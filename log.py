...
# 1. Работа с библиотеками numpy, pandas и matplotlib. 
# 2. Поиск коэфициентов линейной регрессии через функцию MAE посредством библиотек питона. 
# 3. Доопределение производной функции МАЕ посредством библиотек питона. 
# 4. Использование коэффициента learning_rate для изменения значений весов. 
# 5. Построение графика модели с измененными весами. 
